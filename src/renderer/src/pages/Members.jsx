            ...
            <div className="">
              <div>
                <button
                  ...
                  type="button"
                  name="editMember"
                  className="bg-sky-500 rounded-lg w-52 p-1 mb-4 transition delay-150 hover:scale-105"
                >
                  Edit
                </button>
              </div>
              ...
              <div className="shadow p-4 rounded mb-4">
                <h1 className="font-semibold text-3xl text-primary-600 underline">
                  Member details
                </h1>
                ...
                <h1>Marital Status: {memberDetails.maritalStatus.dataValues.title}</h1>
